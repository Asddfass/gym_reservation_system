...
<head>
    ...
    <title>Notifications | Gym Reservation System</title>
...
<body>
    <div class="user-content container-fluid px-4 py-4">
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-4">
                <div class="card card-info bg-crimson text-white text-center p-3">
                    <i class="bi bi-bell-fill fs-3 mb-2"></i>
                    <h4><?= count($notifications) ?></h4>
                    <p class="mb-0">Total Notifications</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card card-info bg-gold text-dark text-center p-3">
            ...
            <div class="col-md-4">
                <div class="card card-info bg-darkred text-white text-center p-3">
                    <i class="bi bi-envelope-open-fill fs-3 mb-2"></i>
